...
## [0.0.4](https://github.com/solodmd/deepagents/compare/deepagents-talon==0.0.3...deepagents-talon==0.0.4) (2026-07-24)
...
* **talon:** `DEEPAGENTS_TALON_RECURSION_LIMIT` env var ([#4354](https://github.com/solodmd/deepagents/issues/4354)) ([82d1eac](https://github.com/solodmd/deepagents/commit/82d1eac59a43f096096e86849733aa716adb18fc))
* **talon:** add Fleet zip import command ([#4493](https://github.com/solodmd/deepagents/issues/4493)) ([0289dd0](https://github.com/solodmd/deepagents/commit/0289dd0a190e5060e631e840da115dd59c64cf5c))
* **talon:** add reaction approval routing ([#4345](https://github.com/solodmd/deepagents/issues/4345)) ([3fe8c0c](https://github.com/solodmd/deepagents/commit/3fe8c0c35536626f583df08573469506b9529706))
* **talon:** add Telegram channel adapter, CLI wiring, and offset persistence ([#4097](https://github.com/solodmd/deepagents/issues/4097)) ([7c87cec](https://github.com/solodmd/deepagents/commit/7c87ceca069874db8555705efab3973301baa1cb))
* **talon:** add tool approval env override ([#4349](https://github.com/solodmd/deepagents/issues/4349)) ([d26481d](https://github.com/solodmd/deepagents/commit/d26481da615881bae4401dfa485ad925945e667a))
* **talon:** audit reaction approval attempts ([#4348](https://github.com/solodmd/deepagents/issues/4348)) ([d7895c4](https://github.com/solodmd/deepagents/commit/d7895c4f9b996ad6fe194936bbeaa8beea21e913))
* **talon:** ingest Telegram approval reactions ([#4346](https://github.com/solodmd/deepagents/issues/4346)) ([437af0b](https://github.com/solodmd/deepagents/commit/437af0bf79332b20ae0c1883c3cc4d91a98c2457))


### Bug Fixes

* **talon:** materialize agents under home ([f2b26a8](https://github.com/solodmd/deepagents/commit/f2b26a8915fb70c26d32af6e8240442e5e6118e6))
