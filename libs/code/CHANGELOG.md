...
## [0.1.73](https://github.com/solodmd/deepagents/compare/deepagents-code==0.1.72...deepagents-code==0.1.73) (2026-09-21)


### Features

* **code,evals:** inject goal/rubric context, dropping `get_goal`/`get_rubric` ([#5041](https://github.com/solodmd/deepagents/issues/5041)) ([2c80153](https://github.com/solodmd/deepagents/commit/2c801537885ea511c91fc880f6f8daa0a71342be))
* **code:** `/context-doctor` ([#5830](https://github.com/solodmd/deepagents/issues/5830)) ([80719ce](https://github.com/solodmd/deepagents/commit/80719ceee8d12060d7ffcdfff880777dc3aaf212))
* **code:** `managed_config.toml` ([#5604](https://github.com/solodmd/deepagents/issues/5604)) ([d419122](https://github.com/solodmd/deepagents/commit/d419122bfb748a823d1fa7cfd7207c428f4fbcab))
* **code:** add `/summarization-model` ([#5884](https://github.com/solodmd/deepagents/issues/5884)) ([4f34c51](https://github.com/solodmd/deepagents/commit/4f34c51d4b9f6ed508af6a8e1ca6dbcf6e3e3877))
* **code:** add `editable` trace metadata ([#5737](https://github.com/solodmd/deepagents/issues/5737)) ([23b83ad](https://github.com/solodmd/deepagents/commit/23b83ad50f63d241d0069a3dc426d43b211adf2e))
* **code:** add `google_anthropic_vertex` provider for Claude on Vertex AI ([#5760](https://github.com/solodmd/deepagents/issues/5760)) ([aa69916](https://github.com/solodmd/deepagents/commit/aa69916baf74c904a70a7497f78752d294df82ac))
* **code:** add `GPT-6 Astra` support ([#6141](https://github.com/solodmd/deepagents/issues/6141)) ([048f989](https://github.com/solodmd/deepagents/commit/048f9890bfe8b640e1e72085a4fa50d9084545f0))
* **code:** add Baseten `zai-org/GLM-5.3-Flash` to model switcher ([#5844](https://github.com/solodmd/deepagents/issues/5844)) ([731d2d5](https://github.com/solodmd/deepagents/commit/731d2d5a56dc0f9e78cec77722af592ad939edd3))
* **code:** add extension trust and inspection UX ([#5634](https://github.com/solodmd/deepagents/issues/5634)) ([da5dcdc](https://github.com/solodmd/deepagents/commit/da5dcdc1df38218f50d57be37908bc39438e3f2b))
* **code:** add optional extra uninstall commands ([#5875](https://github.com/solodmd/deepagents/issues/5875)) ([d36f226](https://github.com/solodmd/deepagents/commit/d36f22694d4b5d9ac9fa806292389954861cd53b))
* **code:** attribute skill invocations in trace metadata ([#5925](https://github.com/solodmd/deepagents/issues/5925)) ([68fa627](https://github.com/solodmd/deepagents/commit/68fa627522e60fe5d5278b454d21fa63a40b2d35))
* **code:** bind conversations to a recorded workspace ([#5946](https://github.com/solodmd/deepagents/issues/5946)) ([4ca758e](https://github.com/solodmd/deepagents/commit/4ca758ed8efd9b586b26685bc3dc787501f3d502))
* **code:** CLI config provider ([#5774](https://github.com/solodmd/deepagents/issues/5774)) ([951a1cf](https://github.com/solodmd/deepagents/commit/951a1cf54b9fa373f1853685b21a084512ab2937))
* **code:** condense status bar cwd from the middle, tail intact ([#6252](https://github.com/solodmd/deepagents/issues/6252)) ([f733893](https://github.com/solodmd/deepagents/commit/f7338933e5ebd6959820023efb66704d6ab8ce7f))
* **code:** configure and load Python extensions ([#5632](https://github.com/solodmd/deepagents/issues/5632)) ([017d7ae](https://github.com/solodmd/deepagents/commit/017d7ae41fe1dfe3fe7fa07bfa206959170707ed))
* **code:** confirm model switches with large context ([#5829](https://github.com/solodmd/deepagents/issues/5829)) ([acc3d33](https://github.com/solodmd/deepagents/commit/acc3d33f357c027ec298bf7682d407a15249e706))
* **code:** copy current model from picker header ([#5904](https://github.com/solodmd/deepagents/issues/5904)) ([cfd9e7a](https://github.com/solodmd/deepagents/commit/cfd9e7aedfd4438d284bf5b567dbc858936af2e4))
* **code:** copy model slug with Ctrl+click ([#6243](https://github.com/solodmd/deepagents/issues/6243)) ([8a5c317](https://github.com/solodmd/deepagents/commit/8a5c317e45edb0df4ad42ae79c1c5a6f8cff407f))
* **code:** default Auto classifier by provider ([#6039](https://github.com/solodmd/deepagents/issues/6039)) ([99ed6c8](https://github.com/solodmd/deepagents/commit/99ed6c83238851eb334e19b27d3faec8869fc9a7))
* **code:** default general-purpose subagents to fork mode ([#6024](https://github.com/solodmd/deepagents/issues/6024)) ([d3ad134](https://github.com/solodmd/deepagents/commit/d3ad134a49287d80b9897b0ef38b4635f8d7de94))
* **code:** default the stale editable-deps prompt to `Refresh environment now` ([#5810](https://github.com/solodmd/deepagents/issues/5810)) ([de60958](https://github.com/solodmd/deepagents/commit/de60958a7d79bd4f63b678e8b4e3f02230060879))
* **code:** define and discover Python extensions ([#5631](https://github.com/solodmd/deepagents/issues/5631)) ([738bf07](https://github.com/solodmd/deepagents/commit/738bf077f8b079164f11742bfcaa2fa93df138d7))
* **code:** enable secret redaction by default ([#5816](https://github.com/solodmd/deepagents/issues/5816)) ([fd7d268](https://github.com/solodmd/deepagents/commit/fd7d2682271cc36180f361f89d1a69557637a03f))
* **code:** encode multi-select `ask_user` answers as JSON arrays ([#5660](https://github.com/solodmd/deepagents/issues/5660)) ([fc70294](https://github.com/solodmd/deepagents/commit/fc70294bcf9ac134c21646bcbe8546aab001442d))
* **code:** enforce configured model allowlists ([#5649](https://github.com/solodmd/deepagents/issues/5649)) ([dd8b8ad](https://github.com/solodmd/deepagents/commit/dd8b8ad84aab54dfe1da4a277dfa9539a03e645c))
* **code:** highlight shell commands in the chat input ([#5675](https://github.com/solodmd/deepagents/issues/5675)) ([d711bc6](https://github.com/solodmd/deepagents/commit/d711bc61300090181dc89e3e116e8b343fb65425))
* **code:** host Python extensions in the agent runtime ([#5633](https://github.com/solodmd/deepagents/issues/5633)) ([2c8d154](https://github.com/solodmd/deepagents/commit/2c8d154c7616071919cab4947403dff701e74b31))
* **code:** limit thread resume age ([#6068](https://github.com/solodmd/deepagents/issues/6068)) ([318311f](https://github.com/solodmd/deepagents/commit/318311f56c3d3b9c4af4ece22fcfc387eeece5cc))
* **code:** link doctor commit hash to GitHub ([#5920](https://github.com/solodmd/deepagents/issues/5920)) ([c9e6f55](https://github.com/solodmd/deepagents/commit/c9e6f55c3ee4b6efedfc945fd1c9b160e6e2a872))
* **code:** list DeepSeek V4.1 Flash in picker ([#6254](https://github.com/solodmd/deepagents/issues/6254)) ([0a93587](https://github.com/solodmd/deepagents/commit/0a9358749d7654cc0bd9273a9e007be89abf316d))
* **code:** list MCP servers needing login ([#5867](https://github.com/solodmd/deepagents/issues/5867)) ([a71cafd](https://github.com/solodmd/deepagents/commit/a71cafdbbd851db65dc311eebe5574982866b222))
* **code:** load managed config from a remote source ([#5776](https://github.com/solodmd/deepagents/issues/5776)) ([9f3a1dd](https://github.com/solodmd/deepagents/commit/9f3a1dd38f8b5dbd828d2f366e9b03dad359fadf))
* **code:** make `/offload` server-owned ([#5261](https://github.com/solodmd/deepagents/issues/5261)) ([b494f43](https://github.com/solodmd/deepagents/commit/b494f43437de3569c8c512d65f5f3accda8e0730))
* **code:** make project `.env` loading configurable ([#5726](https://github.com/solodmd/deepagents/issues/5726)) ([995cad6](https://github.com/solodmd/deepagents/commit/995cad67519af294851282133f8c40f643807c88))
* **code:** make teardown usage stats configurable ([#5696](https://github.com/solodmd/deepagents/issues/5696)) ([c1d965a](https://github.com/solodmd/deepagents/commit/c1d965aa0db93f923ec17947fab34a5300c19141))
* **code:** model-node retry middleware for transient model errors ([#4569](https://github.com/solodmd/deepagents/issues/4569)) ([948fea8](https://github.com/solodmd/deepagents/commit/948fea88e2c1e0660a3c1c7a077121c573f11675))
* **code:** move MCP onto FastMCP and `langchain.mcp` ([#5922](https://github.com/solodmd/deepagents/issues/5922)) ([0692ef1](https://github.com/solodmd/deepagents/commit/0692ef1550568a585afe48705d54a4aa07002697))
* **code:** open footer pickers on click ([#5674](https://github.com/solodmd/deepagents/issues/5674)) ([4f65325](https://github.com/solodmd/deepagents/commit/4f65325ed322ce1c650152b31532b219bfa3850c))
* **code:** open summarization model picker ([#5932](https://github.com/solodmd/deepagents/issues/5932)) ([f90d4fe](https://github.com/solodmd/deepagents/commit/f90d4fe114efe1de1e3d8dd8e5aee5b9f631093d))
* **code:** optionally show visible reasoning ([#5887](https://github.com/solodmd/deepagents/issues/5887)) ([457ac43](https://github.com/solodmd/deepagents/commit/457ac435e1216d3f7cac76d4e856b7aa020b5ea8))
* **code:** prompt clipboard ([#5733](https://github.com/solodmd/deepagents/issues/5733)) ([c2f44ff](https://github.com/solodmd/deepagents/commit/c2f44ffd2759401a5ba31b5f7c41a12b441d6663))
* **code:** re-auth MCP servers from viewer ([#5637](https://github.com/solodmd/deepagents/issues/5637)) ([d7c24d8](https://github.com/solodmd/deepagents/commit/d7c24d85f7b4d478116f022e1e969ddac89aeb2f))
* **code:** recommend GLM 5.3 models ([#6211](https://github.com/solodmd/deepagents/issues/6211)) ([e7e88d5](https://github.com/solodmd/deepagents/commit/e7e88d5efaf2bbce33237ea323fb68487eabd721))
* **code:** replace Gemini 3.6 Flash with 3.7 Flash ([#5681](https://github.com/solodmd/deepagents/issues/5681)) ([9446182](https://github.com/solodmd/deepagents/commit/94461821d8d7e1ef1f1cd29bc0212c731c195ae5))
* **code:** reuse server across workspace switches ([#6152](https://github.com/solodmd/deepagents/issues/6152)) ([ca2d1ef](https://github.com/solodmd/deepagents/commit/ca2d1ef7f270d0fa1040e5473f43e99937b5f03f))
* **code:** show `read_file` arguments when expanded ([#6392](https://github.com/solodmd/deepagents/issues/6392)) ([902905f](https://github.com/solodmd/deepagents/commit/902905f2508fe74dc0ba13d857f502e8ddbc807e))
* **code:** show Auto approval review progress ([#5729](https://github.com/solodmd/deepagents/issues/5729)) ([8fe11f0](https://github.com/solodmd/deepagents/commit/8fe11f0c2566d95b0ca9af6db9ade7a4c58753e6))
* **code:** show cached updates in version output ([#5817](https://github.com/solodmd/deepagents/issues/5817)) ([b6a7792](https://github.com/solodmd/deepagents/commit/b6a77921ceafbe5b6db576e62b5f3f1609e4ebe9))
* **code:** show Escape hint in model picker ([#5775](https://github.com/solodmd/deepagents/issues/5775)) ([a103a88](https://github.com/solodmd/deepagents/commit/a103a88f8a93ef318d64fa9e3bcdd2007cf7a45c))
* **code:** show session length in Debug Console ([#6224](https://github.com/solodmd/deepagents/issues/6224)) ([05edbb1](https://github.com/solodmd/deepagents/commit/05edbb14d0855303ce74d42a4bf368804856c43a))
* **code:** standardize external editor shortcut ([#5911](https://github.com/solodmd/deepagents/issues/5911)) ([f75300f](https://github.com/solodmd/deepagents/commit/f75300f12dc363132dc187e674cf3cd52eb93595))
* **code:** support `DEEPAGENTS_HOME` ([#5773](https://github.com/solodmd/deepagents/issues/5773)) ([feb5736](https://github.com/solodmd/deepagents/commit/feb5736dfb7309008674020442c943ac3e2dc19d))
* **code:** surface locally tracked GitHub stacks ([#6290](https://github.com/solodmd/deepagents/issues/6290)) ([c08cae6](https://github.com/solodmd/deepagents/commit/c08cae693e0036fcd45d979a7dfa3a7e306a0515))
* **code:** trace effective approval mode ([#5972](https://github.com/solodmd/deepagents/issues/5972)) ([c56958d](https://github.com/solodmd/deepagents/commit/c56958d633cd9513ba699f940d4fadfee6cd3963))
* **code:** unify notification center and settings ([#5698](https://github.com/solodmd/deepagents/issues/5698)) ([9767f42](https://github.com/solodmd/deepagents/commit/9767f420c622a31a7511c4601739534ddc6062a7))
* **sdk,code:** update `read_file` output formatting ([#5648](https://github.com/solodmd/deepagents/issues/5648)) ([276beca](https://github.com/solodmd/deepagents/commit/276becae1bbaa38d6253aee90e99212e7bdf0606))


### Bug Fixes

* **code,evals:** allow instrumental Auto actions ([#5832](https://github.com/solodmd/deepagents/issues/5832)) ([56f51d8](https://github.com/solodmd/deepagents/commit/56f51d83a7d6621f2c3954ce69740c46e3cc1426))
* **code:** accept bare relative paths in marketplace plugin sources ([#5959](https://github.com/solodmd/deepagents/issues/5959)) ([28468d6](https://github.com/solodmd/deepagents/commit/28468d62f208e3dea5a574898d19e7d9618db928))
* **code:** align file and console debug log formatting ([#6426](https://github.com/solodmd/deepagents/issues/6426)) ([6c219d3](https://github.com/solodmd/deepagents/commit/6c219d3a39a869b55c5ec434acf76f84217eb002))
* **code:** align prompt clipboard word deletion ([#6345](https://github.com/solodmd/deepagents/issues/6345)) ([777d633](https://github.com/solodmd/deepagents/commit/777d6336de3c7f1b6759a3f092fbfeddc4c54499))
* **code:** align wrapped debug snapshot values ([#5727](https://github.com/solodmd/deepagents/issues/5727)) ([1f74959](https://github.com/solodmd/deepagents/commit/1f7495949232fe2e3e3328b6ff9054c202002f95))
* **code:** append refreshed local context after compaction ([#5828](https://github.com/solodmd/deepagents/issues/5828)) ([3a78de7](https://github.com/solodmd/deepagents/commit/3a78de7c3feeea4bc180e91003f6a43ee1a29064))
* **code:** attribute dotenv config sources ([#6222](https://github.com/solodmd/deepagents/issues/6222)) ([6f1ac85](https://github.com/solodmd/deepagents/commit/6f1ac85c46604ef093a9d295fbcc52a8108aa8ed))
* **code:** bind request-time working directories ([#5968](https://github.com/solodmd/deepagents/issues/5968)) ([98db566](https://github.com/solodmd/deepagents/commit/98db566f2cc654a535ed68de4dbdd2e10a2edd30))
* **code:** block dotenv git config injection keys ([#5723](https://github.com/solodmd/deepagents/issues/5723)) ([328f916](https://github.com/solodmd/deepagents/commit/328f9160e0f95a459be8ad57f76e7178b24a3ef8))
* **code:** bound transcript tail reconciliation ([#6057](https://github.com/solodmd/deepagents/issues/6057)) ([8da3264](https://github.com/solodmd/deepagents/commit/8da32644dc7dcad1125a840bc17ec3d5ea66b8c3))
* **code:** cap MCP tool names for provider compatibility ([#5953](https://github.com/solodmd/deepagents/issues/5953)) ([0eb8e57](https://github.com/solodmd/deepagents/commit/0eb8e578708a18c3a789f76c4bb13d92bd768192))
* **code:** capture stdio MCP server stderr into the logger ([#5610](https://github.com/solodmd/deepagents/issues/5610)) ([a61bc6f](https://github.com/solodmd/deepagents/commit/a61bc6feeb6aefd780ad8435acc9ce2057fe9151))
* **code:** clarify auth environment setup ([#5767](https://github.com/solodmd/deepagents/issues/5767)) ([a095af9](https://github.com/solodmd/deepagents/commit/a095af93cf3e8ef0c06d9958cfca52dfe9230fcb))
* **code:** clarify Auto mode file-edit example ([#5685](https://github.com/solodmd/deepagents/issues/5685)) ([50dedf0](https://github.com/solodmd/deepagents/commit/50dedf086bb923ec71f585d907ac3920d0442754))
* **code:** clarify clear command descriptions ([#5841](https://github.com/solodmd/deepagents/issues/5841)) ([a6b069d](https://github.com/solodmd/deepagents/commit/a6b069db380c5483c414f48d9b57899c749c8528))
* **code:** clarify line number toggle message ([#5694](https://github.com/solodmd/deepagents/issues/5694)) ([bb75e96](https://github.com/solodmd/deepagents/commit/bb75e96192f30ffccb193f2ccdc349a0227ca1af))
* **code:** clarify unknown effort default ([#6337](https://github.com/solodmd/deepagents/issues/6337)) ([5ee1073](https://github.com/solodmd/deepagents/commit/5ee1073e9ab2fe9a286becb27ec7e694a4b3de4f))
* **code:** complete ASCII UI fallbacks ([#5930](https://github.com/solodmd/deepagents/issues/5930)) ([e9a1623](https://github.com/solodmd/deepagents/commit/e9a16234f14ea570e04a936cf8070156d01eae99))
* **code:** confirm server restart for workspace switch ([#6178](https://github.com/solodmd/deepagents/issues/6178)) ([7997203](https://github.com/solodmd/deepagents/commit/7997203245915aa83e87db83252c04391bd00440))
* **code:** deduplicate footer picker clicks ([#6344](https://github.com/solodmd/deepagents/issues/6344)) ([811e927](https://github.com/solodmd/deepagents/commit/811e92738ffa491e991b9dea6573fff57a84d938))
* **code:** defer the recursion limit to the LangGraph server ([#5882](https://github.com/solodmd/deepagents/issues/5882)) ([4379a46](https://github.com/solodmd/deepagents/commit/4379a463a181a978aab206e93cdcc0788f7eac2b))
* **code:** delay hook status in footer ([#6322](https://github.com/solodmd/deepagents/issues/6322)) ([7f9e8ed](https://github.com/solodmd/deepagents/commit/7f9e8ed3a555933902045792da9bb184950ee7b2))
* **code:** demote no-output hint suppression to debug ([#6245](https://github.com/solodmd/deepagents/issues/6245)) ([d93ab33](https://github.com/solodmd/deepagents/commit/d93ab3351bbf4c3687212f665094ccad100f2c08))
* **code:** disable Git terminal prompts in `execute` ([#5878](https://github.com/solodmd/deepagents/issues/5878)) ([a535b61](https://github.com/solodmd/deepagents/commit/a535b610a158a79a2629fac73fa788d7b31f4096))
* **code:** drop `Muse Spark 1.1` recommendation ([#5683](https://github.com/solodmd/deepagents/issues/5683)) ([fa2e8ab](https://github.com/solodmd/deepagents/commit/fa2e8abb4da1f07163cb5ee3daff4d57ea97fe9f))
* **code:** drop stale Anthropic thinking blocks ([#6300](https://github.com/solodmd/deepagents/issues/6300)) ([fe01fac](https://github.com/solodmd/deepagents/commit/fe01fac1fa3c4d30d9379a9e5f4273a622710049))
* **code:** ensure rubric coverage ([#5369](https://github.com/solodmd/deepagents/issues/5369)) ([442933d](https://github.com/solodmd/deepagents/commit/442933da662d4497a29558f889ca972cd36b5488))
* **code:** expose unknown reasoning effort ([#6241](https://github.com/solodmd/deepagents/issues/6241)) ([ed715ee](https://github.com/solodmd/deepagents/commit/ed715eeba608af47c9ed7943822c25d935a30b9e))
* **code:** extend text selection with `Shift` + `click` ([#5732](https://github.com/solodmd/deepagents/issues/5732)) ([e05931b](https://github.com/solodmd/deepagents/commit/e05931b3016ed3d1500df0c5b77402f457ee5686))
* **code:** flush traces before server shutdown ([#5837](https://github.com/solodmd/deepagents/issues/5837)) ([804fdcc](https://github.com/solodmd/deepagents/commit/804fdcc436538686ca345965c0511e0664eb7c34))
* **code:** guard path expansion in the Auto approval gate ([#5941](https://github.com/solodmd/deepagents/issues/5941)) ([46dea07](https://github.com/solodmd/deepagents/commit/46dea076a77f2b580829b5a211469c68b8924f2a))
* **code:** hide inactive F2 tool hint ([#5939](https://github.com/solodmd/deepagents/issues/5939)) ([fd7ba1a](https://github.com/solodmd/deepagents/commit/fd7ba1ac47e9afbf7a60a40010f72130ff47ee25))
* **code:** hide MCP token path outside debug mode ([#5866](https://github.com/solodmd/deepagents/issues/5866)) ([bd79104](https://github.com/solodmd/deepagents/commit/bd791048b3dfafae3df81e89aa81388e26bc9667))
* **code:** hide onboarding Tavily cancel hint ([#5684](https://github.com/solodmd/deepagents/issues/5684)) ([b91da61](https://github.com/solodmd/deepagents/commit/b91da61716253dbcf1805c6dede589ec41a09ec5))
* **code:** hide thread IDs when tracing is disabled ([#5692](https://github.com/solodmd/deepagents/issues/5692)) ([1680237](https://github.com/solodmd/deepagents/commit/1680237e69bf27740001df7a7f67de5a053536c1))
* **code:** increase warm limit to 800 ([#5728](https://github.com/solodmd/deepagents/issues/5728)) ([f954cde](https://github.com/solodmd/deepagents/commit/f954cde37f1171adc2ec3f1516a0393bded47e82))
* **code:** isolate debug logs by thread ([#5921](https://github.com/solodmd/deepagents/issues/5921)) ([4358cce](https://github.com/solodmd/deepagents/commit/4358ccee79dc9350600af02e4e52633b919d7382))
* **code:** isolate LangSmith auth and workspace tracing ([#6061](https://github.com/solodmd/deepagents/issues/6061)) ([794eda8](https://github.com/solodmd/deepagents/commit/794eda83b777a2a7278e5726607e4b305801298d))
* **code:** isolate parallel `task` failures ([#5954](https://github.com/solodmd/deepagents/issues/5954)) ([e0a474f](https://github.com/solodmd/deepagents/commit/e0a474fed575992abc991f6a8049cc8e18e328c0))
* **code:** isolate user shell tracing credentials ([#6242](https://github.com/solodmd/deepagents/issues/6242)) ([35c21fa](https://github.com/solodmd/deepagents/commit/35c21faafe329f4f6932c0941d163306e1aa06e5))
* **code:** keep absolute paths in normal input mode ([#6379](https://github.com/solodmd/deepagents/issues/6379)) ([141ce98](https://github.com/solodmd/deepagents/commit/141ce9851b876f733ef390ead3edbc509536a8e8))
* **code:** keep installed providers visible in `/auth` ([#5689](https://github.com/solodmd/deepagents/issues/5689)) ([f0854e8](https://github.com/solodmd/deepagents/commit/f0854e82ed8cedd8a8455539eef596d1433eb68e))
* **code:** keep long thread resumes responsive ([#5772](https://github.com/solodmd/deepagents/issues/5772)) ([85e1e5b](https://github.com/solodmd/deepagents/commit/85e1e5b130b7501308e7e57d0be389f41f5b72df))
* **code:** let MCP footer wrap on narrow windows ([#5651](https://github.com/solodmd/deepagents/issues/5651)) ([d00926e](https://github.com/solodmd/deepagents/commit/d00926e9e0278d6e74f91622b00d1375c7af19ab))
* **code:** make debug log path click-to-copy ([#5845](https://github.com/solodmd/deepagents/issues/5845)) ([1fc7d1e](https://github.com/solodmd/deepagents/commit/1fc7d1e26d21ff27327b1b0c0a926673c4663001))
* **code:** make prompt clipboard Tab insert ([#5820](https://github.com/solodmd/deepagents/issues/5820)) ([8e03e9c](https://github.com/solodmd/deepagents/commit/8e03e9c37f80a348a14fb87ef875bc2f9b5b3ee9))
* **code:** make tool arg validation errors recoverable ([#5659](https://github.com/solodmd/deepagents/issues/5659)) ([a7027ed](https://github.com/solodmd/deepagents/commit/a7027edc6449e9a7dbf0e082b8747d0999125ca2))
* **code:** move editable path to debug console ([#5850](https://github.com/solodmd/deepagents/issues/5850)) ([e85f4b7](https://github.com/solodmd/deepagents/commit/e85f4b7bd0acc696a3f29f5c298d3353d7d5495f))
* **code:** name models in classifier errors ([#6038](https://github.com/solodmd/deepagents/issues/6038)) ([fff2c77](https://github.com/solodmd/deepagents/commit/fff2c77c755c6d9dce3a6f776a9b94599ad05cfd))
* **code:** offload server config import ([#6089](https://github.com/solodmd/deepagents/issues/6089)) ([90fe4f4](https://github.com/solodmd/deepagents/commit/90fe4f4ac0a1311f1527b1a5cd02bd3ac8664580))
* **code:** only highlight actionable tool rows ([#5769](https://github.com/solodmd/deepagents/issues/5769)) ([b78413c](https://github.com/solodmd/deepagents/commit/b78413c708afae7fba806ae81336007d5d4c0c58))
* **code:** open debug console at log bottom ([#6218](https://github.com/solodmd/deepagents/issues/6218)) ([34f1b6b](https://github.com/solodmd/deepagents/commit/34f1b6b037b24a1f2fe8b1d6112d9f8cdfe32bf2))
* **code:** order debug console log filters ([#6217](https://github.com/solodmd/deepagents/issues/6217)) ([4bbad10](https://github.com/solodmd/deepagents/commit/4bbad10385b22cb76dc40aaa4709d4726f20db02))
* **code:** parse extra skill dirs with platform separator ([#6151](https://github.com/solodmd/deepagents/issues/6151)) ([56e4ef1](https://github.com/solodmd/deepagents/commit/56e4ef1a5f447950a04ba37a7855c8e0babd2f11))
* **code:** persist Auto approval mode between sessions ([#5665](https://github.com/solodmd/deepagents/issues/5665)) ([3ac059e](https://github.com/solodmd/deepagents/commit/3ac059e1574963fe216692642aa1b1a4044daaa9))
* **code:** pin resumed history to newest message ([#6225](https://github.com/solodmd/deepagents/issues/6225)) ([9b5ca38](https://github.com/solodmd/deepagents/commit/9b5ca384ff727f16c4f66a13308170cfba899b97))
* **code:** point model switch warning to `/offload` ([#5901](https://github.com/solodmd/deepagents/issues/5901)) ([2f4d606](https://github.com/solodmd/deepagents/commit/2f4d606ee338720dd6ae6758761f08c3cb9c2350))
* **code:** preload auth UI before notification handoff ([#5697](https://github.com/solodmd/deepagents/issues/5697)) ([57c0678](https://github.com/solodmd/deepagents/commit/57c0678c4994b8b253c5f7edf11b7a558ece7df9))
* **code:** preserve goal notice history for prompt caching ([#5823](https://github.com/solodmd/deepagents/issues/5823)) ([aa8ae71](https://github.com/solodmd/deepagents/commit/aa8ae718644dac19d7f1cdc3febe2740a79fa058))
* **code:** price Fireworks GLM-5.3 Flash usage ([#6223](https://github.com/solodmd/deepagents/issues/6223)) ([d3627ea](https://github.com/solodmd/deepagents/commit/d3627eaaeda2de62c19b0647ac29f80767057241))
* **code:** price Fireworks GLM-5.3 usage ([#6221](https://github.com/solodmd/deepagents/issues/6221)) ([07c5d2e](https://github.com/solodmd/deepagents/commit/07c5d2ecfe5db6238eff782f714fbbe08865e8d4))
* **code:** price nested usage with its own model and honor completions ([#6251](https://github.com/solodmd/deepagents/issues/6251)) ([f413a40](https://github.com/solodmd/deepagents/commit/f413a40f7e74ada749b18491aa276ee1224c7368))
* **code:** protect TUI from native stderr writes ([#5813](https://github.com/solodmd/deepagents/issues/5813)) ([a4d9b8a](https://github.com/solodmd/deepagents/commit/a4d9b8aa7dfde39f37a4fa40aac8b149e2f66b00))
* **code:** ranked durable-mask config resolver ([#5672](https://github.com/solodmd/deepagents/issues/5672)) ([9f24b9f](https://github.com/solodmd/deepagents/commit/9f24b9fcaf7ed399b7888b2f0f9d13363939ea87))
* **code:** recognize in-flight trace messages ([#5738](https://github.com/solodmd/deepagents/issues/5738)) ([f1d1f63](https://github.com/solodmd/deepagents/commit/f1d1f632812a85646d25ac2f3d2d7f39b65a0b49))
* **code:** record Auto classifier deadline as a traced error ([#5944](https://github.com/solodmd/deepagents/issues/5944)) ([9a643c7](https://github.com/solodmd/deepagents/commit/9a643c75843a95d3ef770ac69dd1452435596efe))
* **code:** recover stale pending work before compaction ([#5909](https://github.com/solodmd/deepagents/issues/5909)) ([213f0c8](https://github.com/solodmd/deepagents/commit/213f0c8a7dd01febff2a52c9ca0ea61b2cd8fd9d))
* **code:** refuse a second sandbox workspace ([#5979](https://github.com/solodmd/deepagents/issues/5979)) ([cb4c973](https://github.com/solodmd/deepagents/commit/cb4c973172f7838eefa328ea0c6ca334b6aaab98))
* **code:** reject stale successful updates ([#5847](https://github.com/solodmd/deepagents/issues/5847)) ([23976f4](https://github.com/solodmd/deepagents/commit/23976f414a928eb50d13d351bdc19971098ea7b9))
* **code:** remove notification settings expand flicker and trailing disclosure glyph ([#5734](https://github.com/solodmd/deepagents/issues/5734)) ([5397812](https://github.com/solodmd/deepagents/commit/5397812ad5f217cd84f871f121cf9ea8f3d63f4f))
* **code:** remove review failure approval copy ([#5687](https://github.com/solodmd/deepagents/issues/5687)) ([b6a4146](https://github.com/solodmd/deepagents/commit/b6a41461d1834f673795e39a8928649de142d976))
* **code:** rename OpenAI subscription login label ([#5680](https://github.com/solodmd/deepagents/issues/5680)) ([14b09aa](https://github.com/solodmd/deepagents/commit/14b09aa18567de9325bbf7fa083fe339c90fce0e))
* **code:** render first streamed text immediately ([#5761](https://github.com/solodmd/deepagents/issues/5761)) ([19de73d](https://github.com/solodmd/deepagents/commit/19de73de163d2ca907fa4d9a44f2e19af635aa39))
* **code:** render thread timestamps without the glibc-only `%-I` strftime flag ([#5886](https://github.com/solodmd/deepagents/issues/5886)) ([ef6b5be](https://github.com/solodmd/deepagents/commit/ef6b5beec93bdcbb38ea44f157a029bc07b8b5ee))
* **code:** replace composer with prompt search and prevent query feedback ([#6346](https://github.com/solodmd/deepagents/issues/6346)) ([a52ecea](https://github.com/solodmd/deepagents/commit/a52ecea1f4b159a5ec0c667c6d05e26ea701db30))
* **code:** resolve origin from worktree common Git dir ([#5818](https://github.com/solodmd/deepagents/issues/5818)) ([a8ae714](https://github.com/solodmd/deepagents/commit/a8ae71480f767aac0f0f7cf754ec49e6fd9bf826))
* **code:** resolve project policy per workspace ([#6064](https://github.com/solodmd/deepagents/issues/6064)) ([ea1f253](https://github.com/solodmd/deepagents/commit/ea1f2536537efb01c71dce54c46894b9318c4f80))
* **code:** respect ASCII mode in splash border ([#5923](https://github.com/solodmd/deepagents/issues/5923)) ([437c2db](https://github.com/solodmd/deepagents/commit/437c2dbbe287c6b37a4fe7466b5f9d5305163d85))
* **code:** retry interrupted model streams ([#5905](https://github.com/solodmd/deepagents/issues/5905)) ([dfcd941](https://github.com/solodmd/deepagents/commit/dfcd9417a88c774a232de33e41bb0e69d76ec7ce))
* **code:** run sandbox creation and entry off the guarded event loop ([#6017](https://github.com/solodmd/deepagents/issues/6017)) ([fd28bfb](https://github.com/solodmd/deepagents/commit/fd28bfb5c5e1ca18af975d8e57d361c1c23f81b7))
* **code:** say which source path a plugin install rejected ([#5960](https://github.com/solodmd/deepagents/issues/5960)) ([6f8c488](https://github.com/solodmd/deepagents/commit/6f8c48800b02397fd262bfd9caea5096984d4220))
* **code:** scope project dotenv to workspaces ([#5980](https://github.com/solodmd/deepagents/issues/5980)) ([678c115](https://github.com/solodmd/deepagents/commit/678c11559d7534ee5e16ceebfacf01eeb6536ac7))
* **code:** scroll overflowing chat input pastes ([#6382](https://github.com/solodmd/deepagents/issues/6382)) ([b522fd4](https://github.com/solodmd/deepagents/commit/b522fd4a74b2349b25f3f1f630265f7e456430ee))
* **code:** separate YOLO exit hint ([#5688](https://github.com/solodmd/deepagents/issues/5688)) ([5d604ee](https://github.com/solodmd/deepagents/commit/5d604eed6d7ff567bb6c2c3046e385fc8d987698))
* **code:** serialize transcript tail reconciliation ([#6143](https://github.com/solodmd/deepagents/issues/6143)) ([5fb8b69](https://github.com/solodmd/deepagents/commit/5fb8b699843ecf93debc592d9dbb8a534f54db09))
* **code:** show Auto first-enable notice as pre-confirmation ([#5686](https://github.com/solodmd/deepagents/issues/5686)) ([32f565f](https://github.com/solodmd/deepagents/commit/32f565f46519d9c35919640bdf9374506d0572d2))
* **code:** show bound workspace in shell approvals ([#5966](https://github.com/solodmd/deepagents/issues/5966)) ([716ab9f](https://github.com/solodmd/deepagents/commit/716ab9fb9c1f27d912aac89a663a75c4861418a5))
* **code:** show contextual auth footer actions ([#5690](https://github.com/solodmd/deepagents/issues/5690)) ([074a501](https://github.com/solodmd/deepagents/commit/074a5019e1f3edfd589614774958400d051e5fe1))
* **code:** show incognito shell command widget ([#5768](https://github.com/solodmd/deepagents/issues/5768)) ([9bef676](https://github.com/solodmd/deepagents/commit/9bef676fe69a3b79c0702fda59b555d1ef6ad3bc))
* **code:** show the spinner during pre-stream turn setup ([#6253](https://github.com/solodmd/deepagents/issues/6253)) ([fa609c2](https://github.com/solodmd/deepagents/commit/fa609c23ba883557d015529d431ae266847e388c))
* **code:** silence absent themes config warning ([#6220](https://github.com/solodmd/deepagents/issues/6220)) ([b93f748](https://github.com/solodmd/deepagents/commit/b93f7483bb5722bbae281a19a80a7aea21d38832))
* **code:** silence non-media path decoder traces ([#6427](https://github.com/solodmd/deepagents/issues/6427)) ([3693e9d](https://github.com/solodmd/deepagents/commit/3693e9d01a94a4e881cbb5f92438adfec27cd77e))
* **code:** simplify Auto fallback copy ([#5670](https://github.com/solodmd/deepagents/issues/5670)) ([42afcde](https://github.com/solodmd/deepagents/commit/42afcded97029070f393232778c84aaf3b69fb1c))
* **code:** simplify classifier notice copy ([#5691](https://github.com/solodmd/deepagents/issues/5691)) ([c23c960](https://github.com/solodmd/deepagents/commit/c23c960459e931631842f1a7214b98a2d383f72a))
* **code:** simplify empty `/tokens` message ([#5693](https://github.com/solodmd/deepagents/issues/5693)) ([8a4fc3a](https://github.com/solodmd/deepagents/commit/8a4fc3a3104ab5131bedec0ca1f76289285d5efa))
* **code:** skip background sync in Apple Terminal ([#5666](https://github.com/solodmd/deepagents/issues/5666)) ([a2782ff](https://github.com/solodmd/deepagents/commit/a2782ff36efd5e9c9ebd9abb17b6fb51a2f01e8b))
* **code:** skip unchanged config writes ([#5919](https://github.com/solodmd/deepagents/issues/5919)) ([c313ff0](https://github.com/solodmd/deepagents/commit/c313ff0e6b3549d9f959578ae177291d8c8f13a3))
* **code:** skip uncorrelated-result warning for auto-mode policy denials ([#5869](https://github.com/solodmd/deepagents/issues/5869)) ([35fd008](https://github.com/solodmd/deepagents/commit/35fd00833a03e9e76858195aae8b13e7753cfa47))
* **code:** standardize modal navigation hints ([#5699](https://github.com/solodmd/deepagents/issues/5699)) ([85c6833](https://github.com/solodmd/deepagents/commit/85c6833734a547e968221c1199a769d7aac69430))
* **code:** standardize recent-thread environment variable ([#6205](https://github.com/solodmd/deepagents/issues/6205)) ([a4c218e](https://github.com/solodmd/deepagents/commit/a4c218e185bc49a11a381c3afde91f6efa7226fc))
* **code:** stream tool-call args in linear time ([#5712](https://github.com/solodmd/deepagents/issues/5712)) ([57bfa6b](https://github.com/solodmd/deepagents/commit/57bfa6bdc57056265047744dc32f3337a964ddc8))
* **code:** surface stale updates in-session ([#6063](https://github.com/solodmd/deepagents/issues/6063)) ([cdb9d4c](https://github.com/solodmd/deepagents/commit/cdb9d4c30f4419c0eb2c98ad53940875e4dfbe9e))
* **code:** surface the LangSmith credential in `dcode config` ([#6083](https://github.com/solodmd/deepagents/issues/6083)) ([a1a0887](https://github.com/solodmd/deepagents/commit/a1a0887f7e42d0f8515ad415c9b9062e89350e8c))
* **code:** sweep expired history archives at startup ([#5751](https://github.com/solodmd/deepagents/issues/5751)) ([d9dc96e](https://github.com/solodmd/deepagents/commit/d9dc96ed555c94f9973e9b49d4b12fd543038f8b))
* **code:** track live dynamic subagent cost ([#5833](https://github.com/solodmd/deepagents/issues/5833)) ([37d7777](https://github.com/solodmd/deepagents/commit/37d7777195ff5c30ef789052d02d4387725182b8))
* **code:** treat effort changes as cache identity for OpenAI and Anthropic ([#6196](https://github.com/solodmd/deepagents/issues/6196)) ([cacd50a](https://github.com/solodmd/deepagents/commit/cacd50adc365e949e4f0b9a7e94ad6f8eeb7d497))
* **code:** update rubric grader model without restart ([#5885](https://github.com/solodmd/deepagents/issues/5885)) ([428e760](https://github.com/solodmd/deepagents/commit/428e760668d8fdfbb920966e2969c76040e30745))
* **code:** use sharp splash border ([#5970](https://github.com/solodmd/deepagents/issues/5970)) ([096d20c](https://github.com/solodmd/deepagents/commit/096d20cc7f0d61ed027686b226217f4a717925b0))
* **code:** wait for graph readiness after server restart ([#5947](https://github.com/solodmd/deepagents/issues/5947)) ([358bc33](https://github.com/solodmd/deepagents/commit/358bc3347135793afd12b8b387bda94e61bb6f07))
* **code:** warn and ignore `--auto-approve`/`--yolo` in headless mode ([#5750](https://github.com/solodmd/deepagents/issues/5750)) ([9223593](https://github.com/solodmd/deepagents/commit/922359307cb0e7728ab58613b29631500e9c5abc))
* **code:** wrap debug logs before the scrollbar ([#6219](https://github.com/solodmd/deepagents/issues/6219)) ([ca7999a](https://github.com/solodmd/deepagents/commit/ca7999a8a9984e110a3b80d2e5f71dbe895f58ec))


### Performance Improvements

* **code,quickjs:** omit middleware trace inputs ([#6015](https://github.com/solodmd/deepagents/issues/6015)) ([673844d](https://github.com/solodmd/deepagents/commit/673844d06fe0ee186f2e492c3c0a19ec5facffc2))
* **code:** omit middleware trace inputs ([#5815](https://github.com/solodmd/deepagents/issues/5815)) ([39b760f](https://github.com/solodmd/deepagents/commit/39b760f12452e1b04bcd0fa15850662ce83ceee8))
* **code:** skip transcript scan on prompt submit ([#6402](https://github.com/solodmd/deepagents/issues/6402)) ([443d34b](https://github.com/solodmd/deepagents/commit/443d34bfde4f22cbc7f9ac71be766922a041e08c))
